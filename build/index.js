...
/* harmony import */ var _modules_LoginPanel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/LoginPanel */ "./src/modules/LoginPanel.js");
...
const navScroll = new _modules_NavScroll__WEBPACK_IMPORTED_MODULE_1__["default"]();
const loginPanel = new _modules_LoginPanel__WEBPACK_IMPORTED_MODULE_2__["default"]();

/***/ }),

/***/ "./src/modules/LoginPanel.js":
/*!***********************************!*\
  !*** ./src/modules/LoginPanel.js ***!
  \***********************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
class LoginPanel {
  constructor() {
    ...
    if (this.logPanelID.classList.contains("open")) {
      console.log('open is conatins');
    }
    ;
  }
  panelToggle() {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpcu_theme"] = self["webpackChunkpcu_theme"] || [];
