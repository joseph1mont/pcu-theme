// JS Code copy of pcu-website-old
class PcuOld {
    constructor() {   
...
jQuery(document).ready(function(e) {
    function o(o, n, t, a) {
        ...
        s = Math.max(s, 50);
        var l, d = (new Date).getTime() + a;
        function u() {
            var e = (new Date).getTime()
              , o = Math.max((d - e) / a, 0)
              , n = Math.round(t - o * i);
            r.html(n.toLocaleString()),
            n == t && clearInterval(l)
        }
        l = setInterval(u, s),
        u()
...
jQuery(document).ready(function(e) {
    ...
    function r(o, n) {
        return "" == o.trim() ? (e("#userLoginMessage").find(".message").text("Username required."),
        e("#userLoginMessage").modal(),
        !0) : "" == n.trim() && (e("#userLoginMessage").find(".message").text("Password required."),
        e("#userLoginMessage").modal(),
        !0)
    }
    function i(n, a, r, i) {
        e.ajax({
            ...
            o.modal("hide"),
            t.modal("hide"),
            e("#userLoginMessage").find(".message").text(PointComfort.Errors.TokenFailed),
            e("#userLoginMessage").modal()
        })
    }
    function s(e, o) {
    ...
    e(".login-panel .toggle").on("click", function(o) {
        ...
        $loginpanel.hasClass("open") ? ($loginpanel.addClass("closing"),
        $loginpanel.animate({
            width: "120px"
        }, 500, function() {
            $loginpanel.removeClass("open"),
            $loginpanel.removeClass("closing")
        })) : ($loginpanel.addClass("opening"),
        $loginpanel.animate({
            width: "420px"
        }, 500, function() {
            $loginpanel.addClass("open"),
            $loginpanel.removeClass("opening")
        }))
    }),
    ...
    e("#login-link").on("click", function(o) {
        o.preventDefault(),
        e("#forgot-password-form").hide(),
        e(".forgot-password").show(),
        e("#login-form").show(),
        e(".login").hide()
    }),
    e("#forgot-password-link").on("click", function(o) {
        ...
        e("#login-form").hide(),
        e(".login").show(),
        e("#forgot-password-form").show(),
        e(".forgot-password").hide()
    }),
    ...
    e(".login-widget .login").on("click", function(n) {
        n.preventDefault(),
        a.username = e(".login-widget input[name=username]").val(),
        a.password = e(".login-widget input[name=password]").val(),
        a.fromPanel = !1,
        r(a.username, a.password) || o.modal("show")
    }),
    e("#forgot-password-form").on("submit", function(o) {
        ...
        e(".login-panel .toggle").click(),
        "" == e("#email").val().trim())
            return e("#userLoginMessage").find(".message").text("Email required."),
            void e("#userLoginMessage").modal();
        n.modal("show")
    }),
    e("#userForgotPasswordSpinner").on("shown.bs.modal", function() {
        var o = e("#email").val();
        e.ajax({
            url: PointComfort.API + "/api/forgot-password/",
            method: "POST",
            data: JSON.stringify({
                email: o
            }),
            ...
            if (t.success) {
                var a = function(o) {
                    if (!o.sites || 0 == o.sites.length)
                        return e("#userLoginMessage").find(".message").text(PointComfort.Errors.EmailNotFound),
                        e("#userLoginMessage").modal(),
                        null;
                    if (1 == o.sites.length)
                        return o.sites[0];
                ...
                n.modal("hide"),
                e("#userLoginMessage").find(".message").text(PointComfort.Errors.EmailNotFound),
                e("#userLoginMessage").modal()
        }).fail(function() {
            n.modal("hide"),
            e("#userLoginMessage").find(".message").text(PointComfort.Errors.EmailNotFound),
    ...
    e("#userLoginSpinner").on("shown.bs.modal", function() {
        "True" === e("#UsePortalLogin").val() ? e.ajax({
            url: e("#PortalLoginURL").val(),
            method: "POST",
            data: JSON.stringify(a),
            contentType: "application/json"
        }).done(function(n) {
            n.success ? window.location.href = n.redirect : (o.modal("hide"),
            e("#userLoginMessage").find(".message").text(PointComfort.Errors.LoginFailed),
            e("#userLoginMessage").modal())
        }).fail(function(n) {
            o.modal("hide"),
            e("#userLoginMessage").find(".message").text(PointComfort.Errors.LoginError),
            e("#userLoginMessage").modal()
        }) : e.ajax({
            url: PointComfort.API + "/api/login/",
            method: "POST",
            data: JSON.stringify({
                username: a.username,
                password: a.password
            ...
            if (n.success) {
                var t = function(n) {
                    if (!n.roles || 0 == n.roles.length)
                        return e("#userLoginMessage").find(".message").text(PointComfort.Errors.LoginFailed),
                        e("#userLoginMessage").modal(),
                        null;
                    if (1 == n.roles.length)
                        return n.roles[0];
    ...
    e("#selectLoginPortal").on("click", function() {
        ...
        o.modal("hide"),
        t.modal("show"),
        i(a.username, a.password, n.loginAPI, n.redirectUrl)
    }),
...
var PointComfort = {
    ...
    GetPortalUserInfo: async function() {
        if (null != PointComfort.CurrentUser)
            return PointComfort.CurrentUser;
        let e = new Promise((e,o)=>{
          ...
          , o = await e;
        return PointComfort.CurrentUser = o,
        o
    }
};
...
jQuery(document).ready(function(e) {
    function o() {
        e.each(e(".social-posts"), function(o, n) {
            ...
            if (t.length) {
                ...
                e(n).children(".row").css("width", t.length * a + "px")
            }
        })
    }
    function n() {
        e("body").hasClass("purchase-path-template") || (0 == e(window).scrollTop() && e("#topbar").hasClass("white") ? !e(".navbar-toggler").hasClass("collapsed") && e(".navbar-toggler").is(":visible") || e("#topbar").removeClass("white") : 0 === e(window).scrollTop() || e("#topbar").hasClass("white") || e("#topbar").addClass("white"))
    }
    ...
    e(".social-posts").length && (e(window).on("resize", function() {
        o()
    }),
    o()),
    ...
    e("faq").live("mouseenter", async function() {
        let o = await async function(o) {
            var n = {
                entry: e(o).data("entry")
            };
            let t = new Promise((o,t)=>{
                e.ajax({
                    url: PointComfort.API + "/api/faq/entry",
                    method: "POST",
                    contentType: "application/json",
    ...
    e("glossary").live("mouseenter", async function() {
        if (e(this).parent(".answer").length && !e(this).parent(".answer").height())
            return;
        let o = await async function(o) {
            var n = {
                entry: e(o).data("entry")
            ...
            let t = new Promise((o,t)=>{
                e.ajax({
                    url: PointComfort.API + "/api/glossary/entry",
                    method: "POST",
                    contentType: "application/json",
                    data: JSON.stringify(n)
                }).done(function(e) {
